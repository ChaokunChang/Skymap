...
bool StarPoint::XInRange(StarPoint &center, float length) {
...
bool StarPoint::YInRange(StarPoint &center, float width) {
    if(abs(this->y-center.y) < width/2) return true;
    else return false;
}

bool StarPoint::InRange(StarPoint &center, float length, float width) {
